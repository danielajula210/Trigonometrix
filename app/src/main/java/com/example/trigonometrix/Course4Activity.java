...
public class Course4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView2.setImageResource(R.drawable.fig4_2);

        TextView textView = findViewById(R.id.textViewCourse4);
        String text = getTextFromRawResource(R.raw.ciorna4);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Course4Activity.this, CourseActivity.class);
